...
// init function
Email.prototype.init = function init(we, transporter) {
  this.resetTransporter(we, transporter);
}

Email.prototype.resetTransporter = function resetTransporter(we, transporter) {
 ...
 */
Email.prototype.getConfiguration = function getConfiguration(we) {
 ...
 */
Email.prototype.sendEmail = function sendEmail(type, options, templateVariables, cb) {
  const email = this;
...
Email.prototype.render = function render(email) {
 ...
 * @return {Promise}
 */
Email.prototype.sendP = function sendP(email) {
